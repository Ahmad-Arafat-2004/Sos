...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      linkPrefix:
        "https://www.google.com/maps/place/Amman/@31.8359188,35.6179637,10z/data=!3m1!4b1!4m6!3m5!1s0x151b5fb85d7981af:0x631c30c0f8dc65e8!8m2!3d31.9543786!4d35.9105776!16zL20vMGM3emY?entry=ttu&g_ep=EgoyMDI1MDczMC4wIKXMDSoASAFQAw%3D%3D",
    },
    {
      icon: Clock,
      titleAr: "ساعات العمل",
  ...
  const subjects = [
    ...
    {
      value: "products",
      labelAr: "استفسار عن المنتجات",
      labelEn: "Product Inquiry",
    },
    {
      value: "orders",
      labelAr: "استفسا�� عن الطلبات",
      labelEn: "Order Inquiry",
    },
    {
      value: "wholesale",
      labelAr: "طلبات الجملة",
      labelEn: "Wholesale Orders",
    },
    {
      value: "partnership",
      labelAr: "الشراكة والتوزيع",
      labelEn: "Partnership & Distribution",
    },
    {
      value: "complaints",
      labelAr: "شكاوى ومقترحات",
