...
const categories = [
  ...
  },
  {
    ...
    image: 'https://cdn.builder.io/api/v1/image/assets%2Fe12438f47c744e98a4d75a71611dd8bf%2F16aa7a5869b3427baa3919f899f19dce?format=webp&width=800',
              ...
              <div className="absolute -bottom-6 -start-6 bg-white rounded-2xl shadow-soft-lg p-4 max-w-xs">
                <div className="flex items-center space-x-3 rtl:space-x-reverse">
                  <div className="flex -space-x-1 rtl:space-x-reverse">
                    {[1, 2, 3].map((i) => (
                      <div key={i} className="w-8 h-8 bg-olive-600 rounded-full border-2 border-white"></div>
                    ))}
                  </div>
                  <div>
                    <p className="text-sm font-semibold text-gray-900">
                      {language === 'ar' ? '1000+ عميل راضٍ' : '1000+ Happy Customers'}
                    </p>
