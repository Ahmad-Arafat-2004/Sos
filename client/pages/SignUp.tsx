          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <User className={`absolute top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 ${isRTL ? 'right-3' : 'left-3'}`} />
                <Input
                  id="name"
                  name="name"
                  type="text"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Mail className={`absolute top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 ${isRTL ? 'right-3' : 'left-3'}`} />
                <Input
                  id="email"
                  name="email"
                  type="email"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Lock className={`absolute top-1/2 transform -translate-y-1/2 text-gray-400 w-5 h-5 ${isRTL ? 'right-3' : 'left-3'}`} />
                <Input
                  id="password"
                  name="password"
            ...
            <div className="flex items-start space-x-3 rtl:space-x-reverse">
              ...
              <label htmlFor="terms" className="text-sm text-gray-600">
                {language === 'ar' ? (
                  <>أوافق على <span className="text-olive-600 hover:underline cursor-pointer">الشروط والأحكام</span> و <span className="text-olive-600 hover:underline cursor-pointer">سياسة الخصوصية</span></>
                ) : (
                  <>I agree to the <span className="text-olive-600 hover:underline cursor-pointer">Terms & Conditions</span> and <span className="text-olive-600 hover:underline cursor-pointer">Privacy Policy</span></>
                )}
              </label>
            </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center space-x-3 rtl:space-x-reverse">
              ...
              <span className="text-sm text-gray-700">
                {language === 'ar' ? 'خصومات حصرية للأعضاء' : 'Exclusive member discounts'}
              </span>
            </div>
            <div className="flex items-center space-x-3 rtl:space-x-reverse">
              <div className="w-8 h-8 bg-olive-100 rounded-lg flex items-center justify-center">
              ...
              <span className="text-sm text-gray-700">
                {language === 'ar' ? 'توصيل مجاني للطلبات الكبيرة' : 'Free delivery on large orders'}
              </span>
            </div>
            <div className="flex items-center space-x-3 rtl:space-x-reverse">
              <div className="w-8 h-8 bg-olive-100 rounded-lg flex items-center justify-center">
              ...
              <span className="text-sm text-gray-700">
                {language === 'ar' ? 'نقاط مكافآت على كل عملية شراء' : 'Loyalty points on every purchase'}
              </span>
            </div>
          </div>
        </div>
