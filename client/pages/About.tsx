...
const About: React.FC = () => {
  ...
  const productCategories = [
    {
      ...
      itemsAr: "الكبسة، البرياني، المسالا، الطواجن، المكسيكية، اليونانية، والشوربة",
      itemsEn: "Kabsa, Biryani, Masala, Tagines, Mexican, Greek, and Soup blends"
    },
    {
      icon: "🍃",
      titleAr: "الأعشاب الطبيعية",
      titleEn: "Natural Herbs",
      itemsAr: "الزعتر، المورينجا، الأوريجانو، الكركم، الزنجبيل، القرفة، وجوزة الطيب",
      itemsEn: "Thyme, Moringa, Oregano, Turmeric, Ginger, Cinnamon, and Nutmeg"
    },
    {
      icon: "🫒",
      ...
      itemsEn: "Extra virgin olive oil extracted from the finest local olive crops"
    },
    {
      icon: "🥒",
      ...
      itemsEn: "Peppers, Tomatoes, Olives, Turnips, Cabbage, and Mexican pickles"
    },
    {
      icon: "☀️",
  ...
  const values = [
    ...
    },
    {
      ...
      descEn: "We follow traditional preparation methods inherited through generations"
    },
    {
      icon: Users,
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex items-center justify-center space-x-2 rtl:space-x-reverse mb-8">
              ...
              <span className="text-lg text-olive-700 font-medium">
                {language === 'ar' ? 'مشروع أردني محلي' : 'Local Jordanian Project'}
              </span>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {values.map((value, index) => (
                <div key={index} className="bg-white rounded-2xl p-6 shadow-soft hover:shadow-soft-lg transition-all duration-300">
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {productCategories.map((category, index) => (
                <div key={index} className="bg-white rounded-2xl p-6 shadow-soft hover:shadow-soft-lg transition-all duration-300 group">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h2 className="text-3xl sm:text-4xl font-bold mb-6">
              {language === 'ar' ? 'نكهة زمان، جودة اليوم' : 'Yesterday\'s Flavor, Today\'s Quality'}
            </h2>
